...
const Header = () => {
    ...
    return (
        <div className='flex flex-col items-center text-center mt-20 px-4 text-gray-800'>
            ...
            <p className='mb-8 max-w-wd'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Non, maiores. Accusantium dolorum aut doloribus porro explicabo dicta architecto, eligendi vitae officiis nostrum saepe sit! Praesentium doloribus quasi suscipit nemo eius.
            </p>
